...
function Flags(world) {
	...
	*/
	...
	this.team = morph(this.default,
	{
		...
		capture_bullet_attr: morph(this.default.bullet_attr,
			{type: "explosion", rad: 24, speed: 0, life: 60, ricochet: 0, wall_collide: false, pass_thru: true, expansion: 60})
	});
	...
	this.shock_wave = morph(this.default,
	{
		...
		tank_attr: {max_vel: 5.5},
		weapon_attr: {max_bullets: 1, reload_ticks: 125},
		bullet_attr: {type: "explosion", rad: 24, speed: 0, life: 16, wall_collide: false, pass_thru: true, expansion: 13.5}
	});
